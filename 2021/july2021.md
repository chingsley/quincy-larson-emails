...
I mentioned earlier that freeCodeCamp.org uses more than 60 servers. We'll need more servers as we expand the number of world languages our curriculum is available in (currently: Spanish, Portuguese, Italian, and Chinese, and soon Arabic, Swahili and others). If you want to help our nonprofit pay for servers, there are many ways you can support our mission: https://www.freecodecamp.org/news/how-to-donate-to-free-code-camp/
